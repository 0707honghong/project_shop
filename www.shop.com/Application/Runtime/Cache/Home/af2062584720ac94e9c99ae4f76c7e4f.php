					...
					<form action="<?php echo U();?>" method="post" id="reg">
						<ul>
							...
							<li class="checkcode">
								...
								<img src="<?php echo U('Captcha/show',['nocache'=>NOW_TIME]);?>" alt="" onclick="changeCaptcha(this)" />
								<span>请点击图片切换</span>
								<span class="error_msg"></span>
							</li>
		...
		<script type="text/javascript">
			...
			$('#reg').validate({
				...
				errorPlacement: function(error, ele) {
					//获取错误信息，将错误信息放在error中的innerHtml中
					var msg = error[0].innerHTML;
					//找到错误控件后面的节点
					var node = $(ele).siblings('.error_msg');
					node.html(msg);
