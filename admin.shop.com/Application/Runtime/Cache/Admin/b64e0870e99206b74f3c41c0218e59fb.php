    ...
    <form method="post" action="<?php echo U();?>"enctype="multipart/form-data" >
        <table cellspacing="1" cellpadding="3" width="100%">
            <tr>
                ...
                <td>
                    <input type="text" name="username" placeholder="请输入用户名" size="50" value="<?php echo ($row["username"]); ?>"  />
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="email" size="50" value="<?php echo ($row["email"]); ?>" placeholder="请输入邮箱" />
                    <span class="require-field">*</span>
                </td>
            </tr>
            <tr>
